  ...
  <tr>
    <td style="text-align: right; border: none; height: 20em;">
        <div style="float: right;" align="left">
            <b>Разработал</b>: <br/>
            Орифшоев Бахтиёр Дилдоршоевич <br/>
            <b>Проверил</b>: <br/>
...
https://github.com/baha1411/Kursovaya
...
### Предметная область Фитнес центр.Подсистема работы с товарами.
...
namespace Fitness_Center
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        Tuple.Create("от 2000 до 12000", 2000f, 12000f)
        };
